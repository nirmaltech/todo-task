  ...
  return (
    <>
      <div className="bg-gray-600">
        ...
        <h1 className="bg-slate-800 text-white p-5 text-5xl font-bold text-center ">My Todo App </h1>

        <div className="bg-slate-300 mx-3 md:container md:mx-auto my-5 rounded-xl p-5 min-h-[80vh] md:w-[35%]">
